...
const BlogCart = ({blog}) => {
    ...
    return (
        <div>
            <Link to={`/blog/${id}`} rel="noopener noreferrer" className="max-w-sm transition border-2 hover:scale-105 border-amber-200  mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50 hidden sm:block">
